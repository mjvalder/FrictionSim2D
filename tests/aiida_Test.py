...
# To check if the entry point "lammps.raw" is registered, run in your terminal:
#   verdi plugin list aiida.calculations | grep lammps

# To register a new entry point, ensure your plugin's entry_points.txt includes:
# [aiida.calculations]
# lammps.raw = your_module_path:LammpsRawCalculation
